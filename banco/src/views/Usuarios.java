...
public class Usuarios extends JDialog {
	...
	public Usuarios() {
		...
		btnAdicionar.setBounds(211, 191, 89, 63);
		...
		btnEditar.setBounds(310, 191, 89, 63);
		...
		btnExcluir.setBounds(409, 191, 89, 63);
		...
		btnLimpar.setIcon(new ImageIcon(Usuarios.class.getResource("/img/limpar48x48.png")));
		btnLimpar.setBounds(87, 206, 48, 48);
